...
local function is_compostable(input)
	if minetest.get_item_group(input, 'fossil') > 0 or minetest.get_item_group(input, 'fossil') > 0 then
		return true
	else
		return false
	end
...
local function update_nodebox(pos)
	if is_empty(pos) then
		swap_node(pos, "prehistoric_life:fossil_grinder_empty")
	else
		swap_node(pos, "prehistoric_life:fossil_grinder")
	end
end
...
local function update_timer(pos)
	...
	if timer:is_started() and count < 1 then
		timer:stop()
		meta:set_string('infotext', 'Fossil Grinder')
		meta:set_int('progress', 0)
	end
end
...
local function create_compost(pos)
	...
	for k, v in pairs(stacks) do
        ...
        local options = { "prehistoric_life:soft_tissue", "default:gravel 3", "default:sand 3" }
...
local function on_rightclick(pos, node, clicker, itemstack)
	minetest.show_formspec(
		...
		'prehistoric_life:fossil_grinder',
		formspec(pos)
	)
end
...
minetest.register_node("prehistoric_life:fossil_grinder_empty", {
	description = "Fossil Grinder",
	tiles = {
		"prehistoric_life_fossil_grinder3.png",
		"prehistoric_life_fossil_grinder2.png",
		"prehistoric_life_fossil_grinder1.png",
		"prehistoric_life_fossil_grinder1.png",
		"prehistoric_life_fossil_grinder1.png",
		"prehistoric_life_fossil_grinder1.png"
	},
	...
	node_box = {
		type = "fixed",
		fixed = {
			{0.3125, -0.5, -0.375, 0.375, -0.0625, 0.375}, -- NodeBox1
			{-0.375, -0.5, -0.375, -0.3125, -0.0625, 0.375}, -- NodeBox2
			{-0.375, -0.5, 0.3125, 0.375, -0.0625, 0.375}, -- NodeBox3
			{-0.375, -0.5, -0.375, 0.375, -0.0625, -0.3125}, -- NodeBox4
			{-0.375, -0.5, -0.375, 0.375, -0.4375, 0.375}, -- NodeBox5
			{-0.375, -0.0625, 0.3125, 0.375, 0.5, 0.375}, -- NodeBox6
		}
	}
})

minetest.register_node("prehistoric_life:fossil_grinder", {
	description = "Fossil Grinder",
	tiles = {
		"prehistoric_life_fossil_grinder2.png",
		"prehistoric_life_fossil_grinder2.png",
	...
	node_box = {
		...
		fixed = {
			...
			{-0.375, -0.5, -0.375, 0.375, -0.0625, -0.3125}, -- NodeBox4
			{-0.375, -0.5, -0.375, 0.375, -0.4375, 0.375}, -- NodeBox5
			{-0.375, -0.0625, -0.375, 0.375, 0, 0.375}, -- NodeBox6
		}
	}
})

minetest.register_craftitem("prehistoric_life:fossil", {
	description = "Fossil",
	inventory_image = "prehistoric_life_fossil.png",
	groups = {fossil=1}
	})

minetest.register_craft({
	output = "prehistoric_life:fossil_grinder_empty",
	recipe = {

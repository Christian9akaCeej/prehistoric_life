...
local function is_compostable(input)
	if minetest.get_item_group(input, 'dna_vile') > 0 or minetest.get_item_group(input, 'dna_vile') > 0 then
		return true
	else
		return false
	end
...
local function update_nodebox(pos)
	if is_empty(pos) then
		swap_node(pos, "prehistoric_life:cultivator_empty")
	else
		swap_node(pos, "prehistoric_life:cultivator")
	end
end
...
local function update_timer(pos)
	...
	if timer:is_started() and count < 1 then
		timer:stop()
		meta:set_string('infotext', 'Cultivator')
		meta:set_int('progress', 0)
	end
end
...
local function create_compost(pos)
	...
	for k, v in pairs(stacks) do
        ...
        local options = { "prehistoric_life:dinosaur_egg" }
...
minetest.register_node("prehistoric_life:cultivator_empty", {
	description = "Cultivator",
	tiles = {
		"prehistoric_life_ecm2.png",
		"prehistoric_life_ecm3.png",
		"prehistoric_life_ecm1.png",
		"prehistoric_life_ecm1.png",
		"prehistoric_life_ecm1.png",
		"prehistoric_life_ecm1.png"
	},
	...
	node_box = {
		type = "fixed",
		fixed = {
			{-0.375, -0.5, -0.375, 0.375, -0.1875, 0.375}, -- NodeBox1
			{-0.3125, -0.1875, -0.3125, 0.3125, 0.25, 0.3125}, -- NodeBox2
		}
	}
})

minetest.register_node("prehistoric_life:cultivator", {
	description = "Cultivator",
	tiles = {
		"prehistoric_life_ecm4.png",
		"prehistoric_life_ecm3.png",
		"prehistoric_life_ecm1.png",
		"prehistoric_life_ecm1.png",
		"prehistoric_life_ecm1.png",
...
minetest.register_craftitem("prehistoric_life:dna_vile", {
	description = "DNA Vile",
	inventory_image = "prehistoric_life_dna_vile.png",
	groups = {dna_vile=1}
	})

minetest.register_craft({
	output = "prehistoric_life:cultivator_empty",
	recipe = {

...
mobs:register_mob("prehistoric_life:anzu", {
	...
	on_rightclick = function(self, clicker)
		...
		if tool:get_name() == "farming:meat_raw" then
			clicker:get_inventory():remove_item("main", "farming:wheat 7", "mobs:meat_raw 7")
			minetest.add_entity(self.object:getpos(), "prehistoric_life:anzu_tamed")
			self.object:remove()
		end
	end,
})

...
mobs:register_mob("prehistoric_life:triceratops", {
	...
	textures = {
		{"prehistoric_life_triceratops_male.png"},
                {"prehistoric_life_triceratops_female.png"},
	},
	child_texture = {
	...
	runaway = false,
	drops = {
		{name = "mobs:meat_raw", chance = 1, min = 13, max = 17},
	},
	water_damage = 0,
	lava_damage = 3,
	light_damage = 0,
...
mobs:register_egg("prehistoric_life:triceratops", S("Triceratops"), "prehistoric_life_egg.png", 0)

-- egg entity

minetest.register_craftitem("prehistoric_life:triceratops_hatched", {
	description = "Triceratops Egg (Hatched)",
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		mob = minetest.add_entity(pos1, "prehistoric_life:triceratops")

...
mobs:register_mob("prehistoric_life:ornithomimus", {
	type = "animal",
	passive = true,
	hp_min = 25,
	hp_max = 29,
	...
	visual = "mesh",
	mesh = "prehistoric_life_ornithomimus.b3d",
	textures = {
		{"prehistoric_life_ornithomimus_male.png"},
                {"prehistoric_life_ornithomimus_female.png"},
	},
	child_texture = {
		{"prehistoric_life_ornithomimus_child.png"},
	},
	makes_footstep_sound = true,
	sounds = {
		random = "prehistoric_life_ornithomimus",
	},
	walk_velocity = 1,
	run_velocity = 2,
	runaway = true,
...
mobs:register_egg("prehistoric_life:ornithomimus", S("Ornithomimus"), "prehistoric_life_egg.png", 0)

-- egg entity

minetest.register_craftitem("prehistoric_life:ornithomimus_hatched", {
	description = "Ornithomimus Egg (Hatched)",
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		mob = minetest.add_entity(pos1, "prehistoric_life:ornithomimus")
